...
namespace SQLConncetionADO
{
    public class SqlconnectionCheck
    {
        ...
        public void Conncetion1()
        {
            ...
            string query = string.Format("INSERT INTO PayRoll VALUES(40,'Satish','Mehta','2021-12-31','Busniness Analyst','9852267616','awsthi369@gmail.com','BTM Layout 5st stage','Karanataka','bangalore','M',15000,22000);");
